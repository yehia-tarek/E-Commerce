        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                ...
                <div class="card shadow-lg">
                    <div class="card-body">
                        <form action="{{ route('roles.update', $role->name) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="mb-3">
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Initialize group "Select All" checkboxes based on pre-selected permissions
            function initializeGroupSelectAll() {
                Object.entries(permissionGroups).forEach(([group, groupData]) => {
                    const allChecked = groupData.checkboxes.every(cb => cb.checked);
                    groupData.selectAll.checked = allChecked;
                });

                // Initialize main "Select All" checkbox
            ...
            // Initialize the state of all "Select All" checkboxes
